...
- Use Geist Pixel Square for headings. Use Manrope for descriptions, supporting text, navigation, buttons, and other interface text; do not apply the pixel font to entire page containers. Use DM Mono for code, technical values, and monospaced text.
